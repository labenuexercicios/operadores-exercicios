// Escreva as operações lógicas abaixo em formato de código. Imprima no console se o valor da operação é 
// verdadeira ou falsa:
...
let numero = 5;
console.log(numero > 20, numero < 2);
...
console.log("Resp 1", salarioFixo + auxilioCreche);

console.log("Resp 2", salarioFixo + (salarioFixo * 0.2));

console.log("Resp 3", (salarioFixo + (salarioFixo * 0.2)) * 0.5);
