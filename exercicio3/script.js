...
console.log(`O salário fixo + comissão: R$${salarioMaisAux}`)

//2-
let vendasJan = 5784.50
const comissaoJan = percentComissao * vendasJan
console.log(`A comissão de Fulano em janeiro será de R$${comissaoJan}`)
...
console.log(`Fulano receberá no mês de janeiro o valor de R$${salarioTotalLiquidoJan}`)

//4- 
console.log(`Janeiro: R$${salarioTotalLiquidoJan}`)
...
console.log(`Fevereiro: R$${salarioTotalLiquidoFev}`)
...
console.log(`Março: R$${salarioTotalLiquidoMar}`)
...
console.log(`Abril: R$${salarioTotalLiquidoAbr}`)
...
console.log(`Maio: R$${salarioTotalLiquidoMai}`)
...
console.log(`Junho: R$${salarioTotalLiquidoJun}`)
...
console.log(`A média salarial de janeiro a junho foi R$${mediaSalarial}`)