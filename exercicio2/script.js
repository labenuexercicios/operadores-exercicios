...
console.log('o primeiro numero é divisível pelo o segundo?', +primeiroNumero % +segundoNumero ===0);
console.log('o segundo numero é divisível pelo o primeiro?', +segundoNumero % +primeiroNumero ===0);
