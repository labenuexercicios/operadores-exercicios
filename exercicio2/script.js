...
let numDivisivel = ("O primeiro número é divisível pelo segundo?", numPar == numPar % 2 ) ;
let numDivisivel2 = ("O segundo número é divisível pelo primeiro?", numImpar== numPar % 2);
